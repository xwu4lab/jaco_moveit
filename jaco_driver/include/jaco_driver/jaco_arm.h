...
#include <jaco_msgs/FingerVelocity.h>
...
class JacoArm
{
 public:
    ...
    void fingerVelocityCallback(const jaco_msgs::FingerVelocityConstPtr& finger_vel);
    
    void fullJointVelocityCallback(const jaco_msgs::FullJointVelocityConstPtr& full_joint_vel);
    void fullCartesianVelocityCallback(const jaco_msgs::FullVelocityConstPtr& full_cartesian_vel);
 ...
 private:
    ...
    ros::Timer full_joint_vel_timer_;
    ros::Timer full_cartesian_vel_timer_;
    ...
    double full_joint_vel_timeout_seconds_;
    double full_cartesian_vel_timeout_seconds_;
    ...
    double full_joint_vel_interval_seconds_;
    double full_cartesian_vel_interval_seconds_;
    ...
    ros::Time last_full_joint_vel_cmd_time_;
    ros::Time last_full_cartesian_vel_cmd_time_;
